...
ROBOT_XML_DICT = {
    ...
    "apptronik_apollo": ASSET_ROOT / "apptronik_apollo" / "scene.xml",
}
...
IK_CONFIG_DICT = {
    ...
    "bvh_lafan1": {
        ...
        "apptronik_apollo": IK_CONFIG_ROOT / "bvh_lafan1_to_apollo.json",
    },
    "bvh_nokov": {
